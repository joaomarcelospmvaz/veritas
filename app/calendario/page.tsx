  ...
  return (
    <div className="min-h-[calc(100dvh-112px)] flex flex-col items-center">
      ...
      <div className="my-12 flex items-center justify-center w-full max-w-[1320px] flex-wrap gap-4 px-2 text-white font-bold text-lg">
        <a href="/files/calendario-2025-infantil-fundamental1.pdf" download className="rounded-2xl h-10 px-4 bg-[#476424] flex justify-center items-center">Educação Infantil ao Ensino Fundamental I</a>
        <a href="/files/calendario-2025-fundamental2-medio.pdf" download className="rounded-2xl h-10 px-4 bg-[#4f8e34] flex justify-center items-center">Ensino Fundamental II ao Ensino Médio</a>
      </div>
    </div>
  )
}